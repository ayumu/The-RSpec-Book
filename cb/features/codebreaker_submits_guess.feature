...
Feature: code-breaker submits guess
  ...
  The code-breaker submits a guess of four numbers. The game marks the guess with + and -
  ...
  that matches the number but not the position of number in secret code, the mark
  includes one - sign
